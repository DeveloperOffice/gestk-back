...
class Command(BaseETLCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Query completa para importar todos os registros do Plano de Contas
        query = """
        SELECT
            ct.codi_cta,
            ct.clas_cta,
        ...
        for batch in batch_iterator(data_iterator, BATCH_SIZE):
            with transaction.atomic():
                for row in batch:
                    ...
                    for data_inicio, data_termino, contabilidade, contrato in contratos_empresa:
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"X Erro ao vincular contas-pai: {e}"))
