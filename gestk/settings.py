"""
Django settings for gestk project.
...
WSGI_APPLICATION = 'gestk.wsgi.application'
...
# DEFAULT_AUTO_FIELD = 'django.db.models.UUIDField' # Removido para corrigir o erro de AutoField
